...
/**
 * LaCaixaBankCallbackHandler.java
 *
...
/**
 *  LaCaixaBankCallbackHandler Callback class, Users can extend this class and implement
 *  their own receiveResult and receiveError methods.
 */
public abstract class RampartCallbackHandler {
     ...
     */
    public RampartCallbackHandler(Object clientData){
    ...
    public void receiveResultecho(
            RampartStub.EchoResponse result
    ) {
    }
    ...
    public void receiveResultsayHello(
            RampartStub.SayHelloResponse result
    ) {
    }
